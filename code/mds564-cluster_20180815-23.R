...
# Basic setup
set.seed(2011)
setwd('/Users/allan/Documents/elmhurst/courses/mds564_advanced-data-mining')
...
##################################################
write.csv(df_clusters, 'mds564-cluster-performance-mean_20180816-00.csv')
...
# Write to file
write.csv(t_biz_mean, 'mds564-cluster-performance-mean_20180816-00.csv')
...
dbWriteTable(
  ...
  name = "tor_cluster_performance_mds564", 
  overwrite = TRUE, 
  append = FALSE
)
dbDisconnect(con)
